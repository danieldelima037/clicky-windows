...
export class DeepSeekService {
  ...
  async query(params: DeepSeekQueryParams): Promise<DeepSeekResponse> {
    const apiKey = this.settings.get("deepseekApiKey");
    const useProxy = this.settings.get("useProxy");
    const proxyUrl = this.settings.get("proxyUrl");
    const model = this.settings.get("deepseekModel");
